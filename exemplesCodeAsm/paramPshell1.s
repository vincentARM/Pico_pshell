/* assembly pgm with pShell version 1.2.16 */
/* display parameters command line */
/* exemple : paramPshell1  John Pierre */
.syntax unified
.cpu cortex-m0plus
.thumb
/*********************************************/
/*           CONSTANTES                      */
/********************************************/
.include "functionsC1.inc"      // verify functions version 1.2.16
...
main:
    ...
    ldr r5,[r7,20]         // parameters address (version 1.2.16)
    ldr r4,[r7]            // Parameters number (version 1.2.16)
    cmp r4,#2
    blt 2f                // if < 2
